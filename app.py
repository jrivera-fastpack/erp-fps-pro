            ...
            if not df_g.empty:
                ...
                if df_plot.empty:
                    ...
                    fig.update_traces(
                        ...
                        marker_line_width=0, 
                        opacity=0.95, 
                        width=0.8, # Aún más gruesa
                        textfont_size=22, # Forzar directamente el tamaño aquí
                        textfont_color='#000000',
                        insidetextfont=dict(size=22, color='#000000'),
                        constraintext='none' 
                    )
                    ...
                    altura_dinamica = max(400, len(df_plot['Eje_Y'].unique()) * 85)
                    fig.update_layout(
